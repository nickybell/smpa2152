...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\frame{\frametitle{Fry, ``When Charts Are a Matter of Life and Death''}
\begin{block}{}
    \centering
...
\only<5-6,19>{
    ...
    \begin{itemize}[<+(4)->]
        ...
        \item<19> After ``where do my eyes go first?'', the next question is: \textbf{what is the first idea that comes to mind?}
    \end{itemize}
}

\only<7>{\centering\large Color Contrasts\\~\\\includegraphics[height=.7\textheight]{cherry_blossoms.JPG}}
\only<8>{\centering\large Proximity\\~\\\includegraphics[height=.7\textheight]{vaccination.JPG}}
\only<9>{\centering\large Proximity\\~\\\includegraphics[height=.7\textheight]{ft_partisanship.PNG}}
\only<10>{\centering\large Similarity\\~\\\includegraphics[height=.7\textheight]{solar_power.JPG}}
\only<11>{\centering\large Connectedness\\~\\\includegraphics[height=.7\textheight]{wsj_pay.png}}
\only<12>{\centering\large Connectedness\\~\\\includegraphics[height=.7\textheight]{nyt_admissions.jpg}}
\only<13>{\centering\large Continuity\\~\\\includegraphics[height=.7\textheight]{nyt_antarctic_ice.png}}
\only<14>{\centering\large Continuity\\~\\\includegraphics[height=.7\textheight]{wsj_minimum_wage.jpg}}
\only<15>{\centering\large Closure\\~\\\includegraphics[height=.7\textheight]{ft_immigration.png}}
\only<16>{\centering\large Closure\\~\\\includegraphics[height=.7\textheight]{nyt_candidate_histories.jpg}}
\only<17>{\centering\large Closure\\~\\\includegraphics[height=.7\textheight]{wsj_wfh.png}}
\only<18>{\centering\large Closure\\~\\\includegraphics[height=.7\textheight]{wfh_redesigned.png}}
\only<20>{\centering\includegraphics[width=.9\textwidth]{economist_assasinations.png}}
}
...
\begin{enumerate}[<+->]
        ...
        \item<2-> The main axis should show the scale of the data
        ...
        \item<14-> Pie charts should have no more than two slices
        \item<15-> Not all data should be in a chart
    \end{enumerate}
\column{0.6\textwidth}
\centering
\only<1>{\includegraphics[width=\textwidth]{mlk_travel.jpg}}
...
\only<4>{\includegraphics[width=\textwidth]{nba_covid.jpg}}
\only<5>{\includegraphics[width=\textwidth]{nbc_boy_scouts.png}}
\only<6>{\includegraphics[width=\textwidth]{vehicles_by_income.jpg}}
\only<7>{\includegraphics[width=\textwidth]{stein_robinson_poll.jpeg}}
\only<8>{\includegraphics[width=\textwidth]{DC_covid.png}}
\only<9>{\includegraphics[width=\textwidth]{pa_sen_result.JPG}}
\only<10>{\includegraphics[width=\textwidth]{ft_britishpolit.JPG}}
\only<11>{\includegraphics[width=\textwidth]{wapo_80_degrees.jpeg}}
\only<12>{\includegraphics[width=\textwidth]{wapo_second_choices.jpg}}
\only<13>{\includegraphics[width=\textwidth]{wapo_gas_prices.JPG}}
\only<14>{\includegraphics[width=\textwidth]{fedbudget2020.png}}
\only<15>{\includegraphics[width=\textwidth]{nbc4_rain.jpg}}
\end{columns}
}
