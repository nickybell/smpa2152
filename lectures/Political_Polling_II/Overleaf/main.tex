...
\only<1-2, 6>{
    \begin{itemize}[<+->]
        ...
        \item<6-> When the cognitive load on respondents is too high, they are likely to engage in \textbf{satisficing} or exit the survey entirely (known as survey attrition).
    \end{itemize}
}
