...
You have been assigned the role of a Survey Designer for the class project. Your role is to lead the class in generating ideas for survey questions, write the survey questions, create the data codebook, and oversee a pre-test of the survey.
...
Submit your final questionnaire and Codebook to me by email. They must be in an editable form (Word document, Google Doc, etc.).

Satisfactory completion of the survey questionnaire and codebook will earn you full credit for 50% of your class project grade (i.e., this is a pass/fail part of the assignment).
...
You have been assigned the role of a Principal Investigator for the class project. Your role is to write and revise a Human Subjects Protection Protocol for review by the Field Operations Team (acting as the IRB), and to write the Surveyor Script.
...
You have been assigned the role of a Field Operations Team member for the class project. Your role is three-fold: 1) Act as the Institutional Review Board (IRB) to review the safety protocol, 2) Manage the survey collection schedule, and 3) Oversee data entry.
...
You have been assigned the role of a Survey Analyst for the class project. Your role is to analyze the data using R and write a 500-word op-ed using the survey results for submission to the The GW Hatchet.
