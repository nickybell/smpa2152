...
\begin{tabularx}{\textwidth}{|p{.06\textwidth}p{.94\textwidth}|}
  ...
  \cdashline{2-2}
  \multirow{7}{*}{2} & January 21: Data Visualization \newline \newline
  \ul{Homework} \newline
  ...
  January 26: Correlation vs. Causation \newline \newline
  \ul{Homework} \newline
  ...
  \textbf{February 2: Lab Day - data visualization} \newline \newline
  \ul{Homework} \newline
  $\bullet$ Complete lab assignment by Feb. 3 at 11:59pm \newline \\
  \cdashline{2-2}
  & February 4: Sampling \newline \newline
  \ul{Homework} \newline
  $\bullet$ Watch the video lecture on data wrangling for class
  on Feb. 9 \newline \\
  ...
  \textbf{February 9: Lab Day - data wrangling} \newline \newline
  \ul{Homework} \newline
  $\bullet$ Complete lab assignment by Feb. 10 at 11:59pm \newline \newline \newline
  ...
  \cdashline{2-2}
  & February 18: Political Polling II \newline \newline
  \ul{Homework} \newline
  $\bullet$ None \newline \\
  ...
  \hline
  \multirow{7}{*}{7} &
  February 23: No Class (Professor at conference) \newline \\
  \cdashline{2-2}
  & \textbf{February 25: Guest Speaker - Brian Sokas, Founder at
  GroundTruthAI} \newline \newline
  \ul{Homework} \newline
  $\bullet$ None \newline \\
  ...
  \textbf{March 2: Guest Speaker - Aidan Hughes, Data Journalist at
  Howard Center for Investigative Journalism} \newline \newline
  \ul{Homework} \newline
  $\bullet$ None \newline \\
  \cdashline{2-2}
  & \textbf{March 4: Guest Speaker - Matthew Herdman, Democratic
  Communications Strategist} \newline \newline
  \ul{Homework} \newline
  $\bullet$ Watch the video lecture on political polling for class
  on Mar. 16 \newline \\
  ...
  \textbf{March 16: Lab Day - political polling }\newline \newline
  \ul{Homework} \newline
  $\bullet$ Complete lab assignment by Mar. 17 at 11:59pm \newline
  $\bullet$ Excerpt of Tetlock and Gardner (2015),
  \ul{Superforecasting: The Art and Science
  of Prediction} (on Blackboard) for class on Mar. 18 \newline \\
  \cdashline{2-2}
  & March 18: Predictive Election Models \newline \newline
  \ul{Homework} \newline
  $\bullet$ None \newline \\
  ...
  $\bullet$ None \newline \\
  \cdashline{2-2}
  & March 25: Machine Learning \newline \newline
  \ul{Homework} \newline
  $\bullet$ Watch the video lecture on machine learning for class
  on Mar. 30 \newline \\
  ...
  \textbf{March 30: Lab Day - machine learning} \newline \newline
  \ul{Homework} \newline
  $\bullet$ Complete lab assignment by Mar. 31 at 11:59pm  \newline \\
  \cdashline{2-2}
  & April 1: Preparation for Survey Project \newline \newline
  \ul{Homework} \newline
  $\bullet$ None \newline \\
  ...
  \textbf{April 6: Lab Day - class survey} \newline \newline
  \ul{Homework} \newline
  $\bullet$ Complete lab assignment by Apr. 7 at 11:59pm \newline \\
  \cdashline{2-2}
  & April 8: Qualitative Data
  \newline \newline
  \ul{Homework} \newline
  $\bullet$ Watch the video lecture on machine learning for class
  on Apr. 13 \newline \\
  ...
  \textbf{April 13: Lab Day - text-as-data} \newline \newline
  \ul{Homework} \newline
  $\bullet$ Complete lab assignment by Apr. 14 at 11:59pm \newline \\
  \cdashline{2-2}
  & April 15: Data Investigations \newline \newline
  \ul{Homework} \newline
  $\bullet$ None \newline \\
  ...
  \textbf{April 20: Lab Day - maps} \newline \newline
  \ul{Homework} \newline
  $\bullet$ Complete lab assignment by Apr. 21 at 11:59pm \newline \\
  \cdashline{2-2}
  & April 22: Screening of \ul{Coded Bias} \newline \newline
  \ul{Homework} \newline
  $\bullet$ None \newline \\
  ...
  \textbf{April 27: Guest Speaker - Emily Guskin, Polling Director at
  ABC News} \newline \newline
  \ul{Homework} \newline
  $\bullet$ None \newline \\
  \cdashline{2-2}
