...
\begin{tabularx}{\textwidth}{|p{.06\textwidth}p{.94\textwidth}|}
  ...
  March 30: Screening of \ul{Coded Bias} \newline \newline
  \ul{Homework} \newline
  $\bullet$ None  \newline \\
  \cdashline{2-2}
  & April 1: Qualitative Data \newline \newline
  \ul{Homework} \newline
  $\bullet$ None (no pre-lab video) \newline \\
  ...
  \textbf{April 6: Lab Day - text-as-data} \newline \newline
  \ul{Homework} \newline
  $\bullet$ Complete lab assignment by Apr. 7 at 11:59pm \newline \\
  \cdashline{2-2}
  & April 8: Preparation for Survey Collection
  \newline \newline
  \ul{Homework} \newline
  $\bullet$ None \newline \\
  ...
  \newline \newline \\
  \cdashline{2-2}
  & \textbf{April 22: Guest Speaker - Emily Guskin, Director of Polling at ABC News} \newline \newline
  \ul{Homework} \newline
  $\bullet$ None \newline \\
