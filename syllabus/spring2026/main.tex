...
\begin{tabularx}{\textwidth}{|p{.06\textwidth}p{.94\textwidth}|}
  ...
  \cdashline{2-2}
  & April 1: Screening of \ul{Coded Bias} \newline \newline
  \ul{Homework} \newline
  $\bullet$ None \newline \\
  ...
  April 6: Preparation for Survey Project \newline \newline
  \ul{Homework} \newline
  $\bullet$ None \newline \\
  \cdashline{2-2}
  ...
  \textbf{April 13: Lab Day - class survey} \newline \newline
  \ul{Homework} \newline
  $\bullet$ Complete lab assignment by Apr. 14 at 11:59pm \newline \\
  \cdashline{2-2}
  & April 15: Guest Speaker (tentative) \newline \newline
  \ul{Homework} \newline
  $\bullet$ None \newline \\
  ...
  April 20: No Class (Professor at conference) \newline \newline
  \newline \newline \\
  \cdashline{2-2}
  & \textbf{April 22: Lab Day - text-as-data} \newline \newline
  \ul{Homework} \newline
  $\bullet$ Complete lab assignment by Apr. 23 at 11:59pm \newline \\
  ...
  April 27: Wrapping Up \newline \newline
  \ul{Homework} \newline
  $\bullet$ None \newline \\
  \cdashline{2-2}
  & April 29: No Class (professor at conference) \newline \newline
  \\
  \hline
